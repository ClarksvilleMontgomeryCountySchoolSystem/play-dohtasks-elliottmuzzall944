...
def main():
    color1 = "gray"
    color2 = "pink"
    print("1) Roll a ball using {color1}.\n")
    ...
    if choice2 == "long tail":
        ...
        print(f"5) Add a small bump using {color2} and attach to the back.\n")
    ...
    # TODO Collect choice1
    # CAUTION: You must include the word "body" when checking!
    # TODO Conditional Statement line 1
    # TODO Conditional Statement line 2
    # TODO Conditional Statement line 3
    # TODO Conditional Statement line 4
    # TODO Add step
    # TODO Add step
    # TODO Collect choice2
    # TODO Conditional Statement line 1
    # TODO Conditional statement line 2
    # TODO Conditional statement line 3
    # TODO Conditional statement line 4
